export default function HeadingTags() {
  return (
    ...
    <div id="wd-ai-headings">
      <h4>Lab notes</h4>
        A short paragraph summarizing what this section covers goes here.
      <h5>What I built</h5>
        A sentence describing the example that was put together for this lab.
      <h6>Next step</h6>
        A sentence describing what comes after this exercise.
    </div>
    </>
  );
